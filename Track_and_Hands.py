                    ...
                    if track_id == min(track_ids):
                            ...
                            if results.multi_hand_landmarks: #if hand detected
                                ...
                                for hand_landmarks in results.multi_hand_landmarks: #loop thorugh results
                                    ...
                                    # Get coordinates of thumb fingers
                                    ...
                                    # Draw and print
                                    if thumb_y_tip < thumb_y_mid:
                                        cv2.circle(frame, (thumb_x_tip, thumb_y_tip), 8, (255, 255, 0), -1)
                                        cv2.circle(frame, (thumb_x_mid, thumb_y_mid), 8, (255, 255, 0), -1)
                                    else:
